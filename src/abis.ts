// Generated by @wagmi/cli@0.1.11 on 4/17/2023 at 4:43:56 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
/**
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
 ...
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export const passportConfig = { address: passportAddress, abi: passportABI } as const
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link passportABI}__.
 *
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export function getPassport(config: Omit<GetContractArgs, 'abi' | 'address'> & { chainId?: keyof typeof passportAddress }) {
  return getContract({ abi: passportABI, address: passportAddress[config.chainId as keyof typeof passportAddress], ...config })
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link passportABI}__.
 *
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export function readPassport<TAbi extends readonly unknown[] = typeof passportABI, TFunctionName extends string = string>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi' | 'address'> & { chainId?: keyof typeof passportAddress }
) {
  return readContract({
    abi: passportABI,
    address: passportAddress[config.chainId as keyof typeof passportAddress],
    ...config,
  } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link passportABI}__.
 *
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export function writePassport<TFunctionName extends string, TMode extends WriteContractMode, TChainId extends number = keyof typeof passportAddress>(
  config:
    | (Omit<WriteContractPreparedArgs<typeof passportABI, TFunctionName>, 'abi' | 'address'> & {
        mode: TMode
        chainId?: TMode extends 'prepared' ? TChainId : keyof typeof passportAddress
      })
    | (Omit<WriteContractUnpreparedArgs<typeof passportABI, TFunctionName>, 'abi' | 'address'> & {
        mode: TMode
        chainId?: TMode extends 'prepared' ? TChainId : keyof typeof passportAddress
      })
) {
  return writeContract({ abi: passportABI, address: passportAddress[config.chainId as keyof typeof passportAddress], ...config } as WriteContractArgs<
    typeof passportABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link passportABI}__.
 *
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export function prepareWritePassport<TAbi extends readonly unknown[] = typeof passportABI, TFunctionName extends string = string>(
  config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi' | 'address'> & { chainId?: keyof typeof passportAddress }
) {
...
/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link passportABI}__.
 *
 * - [__View Contract on Optimism Optimism Explorer__](https://explorer.optimism.io/address/0x1846fB181a12644dEc6af707b23B39d2D19C1879)
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x416CC531d3409786825155168003a5d574c4aD75)
 */
export function watchPassportEvent<TAbi extends readonly unknown[] = typeof passportABI, TEventName extends string = string>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, 'abi' | 'address'> & { chainId?: keyof typeof passportAddress },
  callback: WatchContractEventCallback<TAbi, TEventName>
) {
  return watchContractEvent(
    { abi: passportABI, address: passportAddress[config.chainId as keyof typeof passportAddress], ...config } as WatchContractEventConfig<
      TAbi,
      TEventName
    >,
    callback
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link verifierABI}__.
 */
export function getVerifier(config: Omit<GetContractArgs, 'abi'>) {
  return getContract({ abi: verifierABI, ...config })
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link verifierABI}__.
 */
export function readVerifier<TAbi extends readonly unknown[] = typeof verifierABI, TFunctionName extends string = string>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>
) {
  return readContract({ abi: verifierABI, ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link verifierABI}__.
 */
export function writeVerifier<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof verifierABI, TFunctionName>, 'abi'>
    | Omit<WriteContractUnpreparedArgs<typeof verifierABI, TFunctionName>, 'abi'>
) {
  return writeContract({ abi: verifierABI, ...config } as WriteContractArgs<typeof verifierABI, TFunctionName>)
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link verifierABI}__.
 */
export function prepareWriteVerifier<TAbi extends readonly unknown[] = typeof verifierABI, TFunctionName extends string = string>(
  config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>
) {
  return prepareWriteContract({ abi: verifierABI, ...config } as unknown as PrepareWriteContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link verifierABI}__.
 */
export function watchVerifierEvent<TAbi extends readonly unknown[] = typeof verifierABI, TEventName extends string = string>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, 'abi'>,
  callback: WatchContractEventCallback<TAbi, TEventName>
) {
  return watchContractEvent({ abi: verifierABI, ...config } as WatchContractEventConfig<TAbi, TEventName>, callback)
}
...
export function writeErc721Enumerable<TFunctionName extends string>(
  ...
  return writeContract({ abi: erc721EnumerableABI, ...config } as WriteContractArgs<typeof erc721EnumerableABI, TFunctionName>)
}
...
export function writeIerc721Enumerable<TFunctionName extends string>(
  ...
  return writeContract({ abi: ierc721EnumerableABI, ...config } as WriteContractArgs<typeof ierc721EnumerableABI, TFunctionName>)
}
