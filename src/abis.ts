 ...
 */
export function readErc721Enumerable<TAbi extends readonly unknown[] = typeof erc721EnumerableABI, TFunctionName extends string = string>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>
) {
...
export function writeErc721Enumerable<TFunctionName extends string>(
  ...
  return writeContract({ abi: erc721EnumerableABI, ...config } as unknown as WriteContractArgs<typeof erc721EnumerableABI, TFunctionName>)
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link erc721EnumerableABI}__.
 */
export function prepareWriteErc721Enumerable<TAbi extends readonly unknown[] = typeof erc721EnumerableABI, TFunctionName extends string = string>(
  config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>
) {
 ...
 */
export function readIerc721Enumerable<TAbi extends readonly unknown[] = typeof ierc721EnumerableABI, TFunctionName extends string = string>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>
) {
...
export function writeIerc721Enumerable<TFunctionName extends string>(
  ...
  return writeContract({ abi: ierc721EnumerableABI, ...config } as unknown as WriteContractArgs<typeof ierc721EnumerableABI, TFunctionName>)
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link ierc721EnumerableABI}__.
 */
export function prepareWriteIerc721Enumerable<TAbi extends readonly unknown[] = typeof ierc721EnumerableABI, TFunctionName extends string = string>(
  config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>
) {
  return prepareWriteContract({ abi: ierc721EnumerableABI, ...config } as unknown as PrepareWriteContractConfig<TAbi, TFunctionName>)
}
...
export function writeIerc721Metadata<TFunctionName extends string>(
  ...
  return writeContract({ abi: ierc721MetadataABI, ...config } as unknown as WriteContractArgs<typeof ierc721MetadataABI, TFunctionName>)
}
...
export function writeIerc721Receiver<TFunctionName extends string>(
  ...
  return writeContract({ abi: ierc721ReceiverABI, ...config } as unknown as WriteContractArgs<typeof ierc721ReceiverABI, TFunctionName>)
}
