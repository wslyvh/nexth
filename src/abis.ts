// Generated by @wagmi/cli@0.1.11 on 4/6/2023 at 4:39:55 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export function getPassport(config: Omit<GetContractArgs, 'abi' | 'address'> & { chainId?: keyof typeof passportAddress }) {
  return getContract({ abi: passportABI, address: passportAddress[11155111], ...config })
}
...
export function readPassport<TAbi extends readonly unknown[] = typeof passportABI, TFunctionName extends string = string>(
  ...
  return readContract({ abi: passportABI, address: passportAddress[11155111], ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}
...
export function writePassport<TFunctionName extends string, TMode extends WriteContractMode, TChainId extends number = keyof typeof passportAddress>(
  ...
  return writeContract({ abi: passportABI, address: passportAddress[11155111], ...config } as WriteContractArgs<typeof passportABI, TFunctionName>)
}
...
export function prepareWritePassport<TAbi extends readonly unknown[] = typeof passportABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: passportABI, address: passportAddress[11155111], ...config } as unknown as PrepareWriteContractConfig<
    TAbi,
    TFunctionName
  >)
}
...
export function watchPassportEvent<TAbi extends readonly unknown[] = typeof passportABI, TEventName extends string = string>(
  ...
  return watchContractEvent(
    { abi: passportABI, address: passportAddress[11155111], ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback
  )
}
