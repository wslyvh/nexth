import { mainnet, arbitrum, base, linea, polygon, optimism, scroll, baseSepolia } from 'viem/chains'
...
if (process.env.NODE_ENV !== 'production') chains.push(baseSepolia, sepolia, hardhat)
